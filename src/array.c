...
void Array_Declaration()
	  ...
	  system("cls");
   	 FILE *p;
	 char a[500];
	 p=fopen("Array_Declaration.txt","r");
		while(!feof(p))
		{
		fgets(a,500,p);
		printf("%s\n",a);
	...
	void Array_Initialization()
	  ...
	  system("cls");
   	 FILE *p;
	 char a[500];
	 p=fopen("Array_Initialization.txt","r");
		while(!feof(p))
		{
		fgets(a,500,p);
		printf("%s\n",a);
	...
	void Array_Terminology()
	  ...
	  system("cls");
   	  FILE *p;
	  char a[500];
	 p=fopen("Array_Terminology.txt","r");
		while(!feof(p))
		{
		fgets(a,500,p);
		printf("%s\n",a);
	...
	void  One_Dimensional_Array()
	  ...
	  system("cls");
   	 FILE *p;
	 char a[500];
	 p=fopen("One_Dimensional_Array.txt","r");
		while(!feof(p))
		{
		fgets(a,500,p);
		printf("%s\n",a);
	...
	void  Two_Dimensional_Array()
	  ...
	  system("cls");
   	 FILE *p;
	 char a[500];
	 p=fopen("Two_Dimensional_Array.txt","r");
		while(!feof(p))
		{
		fgets(a,500,p);
		printf("%s\n",a);
